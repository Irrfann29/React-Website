...
export default function Ankhein() {
  return (
    <>
        ...
        <div className="flex items-center justify-center h-screen space-x-8 bg-cover bg-[url('https://images.unsplash.com/photo-1504805572947-34fad45aed93?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-center">
        <Eye />
      <Eye />
      </div>
